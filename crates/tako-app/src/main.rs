    ...
    fn new(cx: &mut Context<Self>) -> Self {
        ...
        cx.spawn(async move |this, cx| loop {
            ...
            let prep = this.update(cx, |app: &mut TakoApp, _| {
                ...
                // git パネルが開いていれば cwd からリポルートを取得する
                ...
                (tmux_ctx, filetree_targets, git_cwd, git_selected)
            });
            let Ok((tmux_ctx, filetree_targets, git_cwd, git_selected)) = prep else {
                break;
            };
