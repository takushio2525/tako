...
<<<<<<< HEAD
||||||| parent of b5d10f5 ([修正] cargo test が本番の data dir と HOME 配下の設定へ書かないようにした (#944))
=======
>>>>>>> b5d10f5 ([修正] cargo test が本番の data dir と HOME 配下の設定へ書かないようにした (#944))
...
=======
<<<<<<< HEAD
||||||| parent of 6275bc6 ([改善] テスト由来の事前信頼エントリの掃除口を用意した (#1030))
<<<<<<< HEAD
=======
>>>>>>> 6275bc6 ([改善] テスト由来の事前信頼エントリの掃除口を用意した (#1030))
<<<<<<< HEAD
||||||| parent of b5d10f5 ([修正] cargo test が本番の data dir と HOME 配下の設定へ書かないようにした (#944))
=======
>>>>>>> b5d10f5 ([修正] cargo test が本番の data dir と HOME 配下の設定へ書かないようにした (#944))
