...
- 実測: `scripts/test-setup-deps-prompt-1499.sh` **52 PASS 0 FAIL**（10 秒・CI の macOS ジョブへ登録）。A/B `TAKO_1499_LEGACY=1` は端末でも聞かない = Issue の症状。番犬 5 本・注入 7 通りすべて FAILED → 戻して緑。workspace 5040 passed 0 failed・clippy 3 宇宙 0・fmt 0
