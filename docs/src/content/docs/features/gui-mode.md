...
<figure class="tako-shot">
<img src="/img/chat-view.webp" alt="Claude との会話がチャット画面として表示され、モデル名・コンテキスト残量・ツール実行の折りたたみ・入力欄・スラッシュボタンが並んでいる画面" />
<figcaption>Claude と対話中のペインはチャットビューになる。モデル名・コンテキスト残量・ツール実行の折りたたみ・入力欄がそのまま使える</figcaption>
</figure>
