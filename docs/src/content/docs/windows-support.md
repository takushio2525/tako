...
| 状態 | 件数 | 意味 |
| --- | --- | --- |
| 対応 | 111 / 144（77%） | macOS と同じように使えます |
| 一部対応 | 16 | 使えますが機能が落ちます。落ち方は各表の「差分」列 |
